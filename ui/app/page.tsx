  ...
  return (
    <div className="px-20 py-10 w-screen h-screen flex flex-col items-center overflow-hidden">
      <div className="max-w-[1400px] w-full items-center flex justify-between">
        ...
        <button className="rounded-full text-base cursor-pointer font-medium rocoleta hover:bg-red-50 transition-all duration-300 border-1 hover:text-black hover:border-gray-800 bg-gray-800 px-6 py-2 text-white">Sign in</button>
      </div>
      <div className="flex flex-col justify-center items-center gap-5 mt-40">
        ...
        <div className="px-4 py-4 text-black border-1 rounded-lg w-[450px] h-[125px] rocoleta flex flex-col justify-between">
